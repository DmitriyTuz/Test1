1. запуск - npm start
2. запускаем миграции - npx sequelize-cli db:migrate (в этих миграциях создаются нужные таблицы)
3. далее просто используя например Postmen можно проверить работу эндпоинтсов:
...
4. обработка ошибок сделана для эндпоинтса - http://localhost:5000/api/art/comments, приведённого также выше в котором создаются коментарии
